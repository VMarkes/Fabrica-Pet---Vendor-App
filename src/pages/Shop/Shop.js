    ...
    <div className="container">
      ...
      <div className="search">
                    <form className="form-search">
                      <input id="busca" type="text" placeholder=" " value={valorDaBusca} onChange={handleSubmit} />
                ...
                <div className="products" >
                    ...
                    {Object.entries(groupedProducts).map(([chave, group]) => (
                      <div className="productsList" key={group}>
                        ...
                        {/* Exibe as informações do tamanho selecionado */}
                        <br />
                        <br />
                        ...
                        <p style={{ marginTop: '10px' }}><b>R$:</b> {group.options.find(option => option.id === selectedSize)?.preco}</p>
          ...
          <p>
            {carrinho.map((item, index) => (
              <div className="total-produtos" key={index}>
                <p>{item.referencia} - {item.nome} - {item.size} - Quantidade: {item.quantidade}</p>
