...
function CarrinhoSalvo() {
    ...
    return (
        <div id="cart" className="cart">
            ...
            <div className="btns">
                <button className="gerarPedido"><Link className="backToCart" to="/Shop">Continuar Comprando</Link></button>
                <button  className="gerarPedido" onClick={gerarPedido}>Gerar Orçamento</button>
            </div>
        </div>
    );
}
